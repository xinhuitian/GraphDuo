...
object Edge {
  private[graphv] def lexicographicOrdering[ED] = new Ordering[Edge[ED]] {
  ...
  private[graphv] def edgeArraySortDataFormat[ED] = new SortDataFormat[Edge[ED], Array[Edge[ED]]] {
